...
'    <script src="&CRAPPY_HOME.js/standalone.js" type="text/javascript" charset="utf-8"></script>',
'    ',
...
,p_row_template_name=>'Report - Collection Secondary Content 2 Links'
...
wwv_flow_api.create_authentication(
 p_id=>wwv_flow_api.id(77408989120098355)
...
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830170643'
);
...
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830163811'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830164136'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830164536'
);
...
'                             '':::6:P6_PAGE_FROM,P6_ID_USR:3,'' ||',
'                             usr.id_usr) AS target2,',
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(26153546107666010)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'CLEAR_PAGE_SESSION'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(26153435670666009)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830164616'
);
wwv_flow_api.create_report_region(
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(26224461981476583)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'CLEAR_PAGE_SESSION'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(26223216877476573)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830202134'
);
wwv_flow_api.create_report_region(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830164641'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830164346'
);
wwv_flow_api.create_page_plug(
...
,p_include_in_reg_disp_sel_yn=>'Y'
,p_plug_display_point=>'BODY'
,p_plug_source=>'You can customize the default settings of CrappyBird. So the game is looking like you love it!'
,p_plug_query_row_template=>1
,p_plug_query_options=>'DERIVED_REPORT_COLUMNS'
,p_attribute_01=>'N'
,p_attribute_02=>'HTML'
...
,p_button_condition=>'P7_IS_SAVED'
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(26387622251692020)
,p_name=>'P7_IS_SAVED'
,p_item_sequence=>80
,p_item_plug_id=>wwv_flow_api.id(26271165286712716)
,p_display_as=>'NATIVE_HIDDEN'
...
,p_process_success_message=>'Successfully saved your preferences.'
);
wwv_flow_api.create_page_process(
...
,p_process_success_message=>'Defaults restored.'
);
wwv_flow_api.create_page_process(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830164717'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(26270311120712708)
,p_name=>'P8_SPACER'
,p_item_sequence=>20
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830164815'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(26396485086788581)
,p_name=>'P9_SPACER'
,p_item_sequence=>50
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830164842'
);
wwv_flow_api.create_report_region(
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(26404300424798208)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'CLEAR_PAGE_SESSION'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(26403125294798206)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830164510'
);
wwv_flow_api.create_report_region(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830164908'
);
wwv_flow_api.create_page_plug(
...
wwv_flow_api.create_page_item(
 p_id=>wwv_flow_api.id(26858239843304048)
,p_name=>'P14_SPACER'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_api.id(26857045280304046)
,p_post_element_text=>'<br>'
...
,p_cache_mode=>'NOCACHE'
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'ADMIN@DANIELH.DE'
,p_last_upd_yyyymmddhh24miss=>'20150820220801'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830164949'
);
wwv_flow_api.create_report_region(
...
wwv_flow_api.create_page_process(
 p_id=>wwv_flow_api.id(26479887245872157)
,p_process_sequence=>10
,p_process_point=>'AFTER_SUBMIT'
,p_process_type=>'NATIVE_SESSION_STATE'
,p_process_name=>'CLEAR_PAGE_SESSION'
,p_attribute_01=>'CLEAR_CACHE_CURRENT_PAGE'
,p_error_display_location=>'INLINE_IN_NOTIFICATION'
,p_process_when_button_id=>wwv_flow_api.id(26478636959872156)
);
end;
/
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150820233041'
);
wwv_flow_api.create_page_plug(
...
,p_cache_mode=>'NOCACHE'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830165249'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830170454'
);
wwv_flow_api.create_page_plug(
...
,p_help_text=>'No help is available for this page.'
,p_last_updated_by=>'DH'
,p_last_upd_yyyymmddhh24miss=>'20150830170512'
);
wwv_flow_api.create_page_plug(
